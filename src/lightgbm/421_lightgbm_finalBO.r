...
PARAM$finalmodel$num_iterations <- 1431
PARAM$finalmodel$learning_rate <- 0.01064752759
PARAM$finalmodel$feature_fraction <-0.4521866745
PARAM$finalmodel$min_data_in_leaf <- 1104
PARAM$finalmodel$num_leaves <- 114

PARAM$finalmodel$max_bin <- 227
